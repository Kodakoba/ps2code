#include <kernel.h> //include the standard PS2 library
...
#include <dma_tags.h>
#include <gif_tags.h> //different parts of the PS2 architecture includes
#include <gs_psm.h>

#include <dma.h>

#include <graph.h> //you do something weird for averages

#include <draw.h>
#include <draw3d.h> //display to screen library

#include "mesh_data.c" //our "object"

VECTOR object_position = { 0.00f, 0.00f, 0.00f, 1.00f };
VECTOR object_rotation = { 0.00f, 0.00f, 0.00f, 0.00f }; //defineing object

VECTOR camera_position = { 0.00f, 0.00f, 100.00f, 1.00f }; //define camera
